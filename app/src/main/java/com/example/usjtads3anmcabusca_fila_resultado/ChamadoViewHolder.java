...
public class ChamadoViewHolder extends RecyclerView.ViewHolder {
    ...
    public ChamadoViewHolder (View v){
        ...
        descricaoChamadoNaFilaTextView = v.findViewById(R.id.descricaoChamadoNaFilaTextView);
        statusChamadoNaFilaTextView = v.findViewById(R.id.statusChamadoNaFilaTextView);
        dataAberturaChamadoNaFilaTextView = v.findViewById(R.id.dataAberturaChamadoNaFilaTextView);
        dataFechamentoChamadoNaFilaTextView = v.findViewById(R.id.dataFechamentoChamadoNaFilaTextView);
    }
}
